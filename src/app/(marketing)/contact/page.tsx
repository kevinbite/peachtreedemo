...
export const metadata = {
  ...
  description:
    'Get a free quote for your commercial interior demolition project. Call (678) 402-6298 or fill out our contact form. Serving Atlanta and the Southeast.',
}
...
const contactInfo = [
  {
    icon: Phone,
    title: 'Phone',
    details: '(678) 402-6298',
    link: 'tel:678-402-0111',
  },
  {
    icon: Mail,
    title: 'Email',
